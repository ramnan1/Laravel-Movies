...
<head>
  ...
  <title>Ramnan Movies</title>
  {{-- @vite('resources/css/main.css') --}}
  <link rel="stylesheet" href="\build\assets\main-3bd2ccda.css">
  @livewireStyles
...
<body class="font-sans bg-gray-900 text-white">
    ...
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
      ...
      <div class="flex items-center flex-col md:flex-row">
        ...
        <div class="md:ml-4 mt-3 md:mt-0">
          <a href="#">
            <img src="/img/ramnan.png" alt="avatar" class="rounded-full w-8 h-8">
          </a>
        </div>
      </div>
    </div>
  ...
  <footer class="border border-t border-gray-800">
    <div class="container ml-8 text-sm px-4 py-6">
      <span class="text-md bold">&copy; Copyright Paly Ramnan</span> Powered by <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300">TMDb API</a>
    </div>
</footer>
  @livewireScripts
  @yield('infinite')
